...
__all__ = ['DetectionPipeline', 'plt_frames_faces', 'plt_frames_faces_vert', 'get_first_face', 'VideoFaceList',
           'EasyRetinaFace', 'nms', 'BlazeBlock', 'BlazeFace', 'intersect', 'jaccard', 'overlap_similarity',
           'EasyBlazeFace']
...
# %load ../face_detection/EasyBlazeFace.py
...
class EasyBlazeFace:
    ...
    def __init__(self, weights="BlazeFace/blazeface.pth", anchors="BlazeFace/anchors.npy"):
        device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
