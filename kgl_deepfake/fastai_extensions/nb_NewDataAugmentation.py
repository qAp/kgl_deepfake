# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/30_fastai_extensions.nb_NewDataAugmentation.ipynb (unless otherwise specified).

__all__ = ['TimeSeriesItem', 'RicapLoss', 'RicapCallback', 'ricap', 'CutMixCallback', 'rand_bbox', 'cutmix',
           'get_x1_coords', 'get_x1_rand_coords', 'get_x2_coords', 'BlendLoss', 'BlendCallback', 'blend',
           'TfmScheduler', 'MyScheduler', 'cosine_annealing', 'inv_annealing_poly', 'inv_annealing_cos', 'tuplify',
           'get_fn', 'show_multi_img_tfms', 'show_single_img_tfms', 'show_multi_img_tfms', 'show_tfms']
