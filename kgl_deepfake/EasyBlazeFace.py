# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/15_EasyBlazeFace.ipynb (unless otherwise specified).

__all__ = ['BlazeBlock', 'BlazeFace', 'intersect', 'jaccard', 'overlap_similarity', 'EasyBlazeFace']
